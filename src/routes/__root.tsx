...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "سنتر الأستاذ محمد نجم — الرئيسية" },
      { property: "og:description", content: "منصة سنتر الأستاذ محمد نجم لإدارة الطلاب والمجموعات والحضور." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "سنتر الأستاذ محمد نجم — الرئيسية" },
      { name: "twitter:description", content: "منصة سنتر الأستاذ محمد نجم لإدارة الطلاب والمجموعات والحضور." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/5c1bac8a-4a15-4be7-80a2-61ff55f7d980/id-preview-1e145b26--c1e4017e-cbca-472b-ab68-d12926904877.lovable.app-1784704740372.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/5c1bac8a-4a15-4be7-80a2-61ff55f7d980/id-preview-1e145b26--c1e4017e-cbca-472b-ab68-d12926904877.lovable.app-1784704740372.png" },
    ],
    links: [
